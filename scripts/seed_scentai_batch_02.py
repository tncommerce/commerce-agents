...
new_products = [
    {
        ...
        "notes": {
            "top": ["Apple", "Bergamot", "Cardamom"],
            "heart": ["Lavender", "Violet", "Geranium"],
            "base": ["Patchouli", "Vanilla", "Guaiac Wood", "Praline"],
        },
        "community": {
            "source": "Parfumo",
            "rating_10": 8.6,
        ...
        "fragrance_profile": {
            "community_accords": ["sweet", "spicy", "fruity", "woody", "oriental"],
            "scores": {"freshness": 4, "sweetness": 9, "woodiness": 6, "spiciness": 8},
    ...
    },
    {
        ...
        "notes": {
            "top": ["Apple", "Lavender", "Violet", "Jasmine"],
            "heart": ["Vanilla", "Patchouli", "Mandarin Orange", "Bergamot"],
            "base": ["Cardamom", "Geranium", "Sandalwood", "Pepper", "Guaiac Wood"],
        },
        "community": {
            "source": "Parfumo",
            "rating_10": 8.1,
        ...
        "fragrance_profile": {
            "community_accords": ["sweet", "spicy", "fruity", "woody", "synthetic"],
            "scores": {"freshness": 4, "sweetness": 9, "woodiness": 6, "spiciness": 8},
            "score_confidence": "high",
        },
        "market": {
    ...
    },
    {
        ...
        "notes": {
            "top": ["Bergamot", "Lavender", "Mandarin", "Pepper", "Green Apple"],
            "heart": ["Violet", "Jasmine", "Geranium", "Cardamom"],
            "base": ["Patchouli", "Sandalwood", "Vanilla", "Musk", "Guaiac Wood"],
        },
        "community": {
            "source": "Parfumo",
            "rating_10": 8.9,
        ...
        "fragrance_profile": {
            "community_accords": ["sweet", "spicy", "oriental", "woody", "fruity"],
            "scores": {"freshness": 4, "sweetness": 9, "woodiness": 6, "spiciness": 8},
    ...
    },
    {
        ...
        "fragrance_profile": {
            "community_accords": ["sweet", "gourmand", "creamy", "spicy", "woody"],
            "scores": {"freshness": 3, "sweetness": 10, "woodiness": 5, "spiciness": 6},
            "score_confidence": "high",
        },
        "market": {
            "official_price_eur": 290.0,
    ...
    },
    {
        ...
        "fragrance_profile": {
            "community_accords": ["sweet", "gourmand", "creamy", "spicy", "oriental"],
            "scores": {"freshness": 3, "sweetness": 10, "woodiness": 3, "spiciness": 6},
            "score_confidence": "high",
        },
        "market": {
