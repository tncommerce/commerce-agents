...
def build_shopping_config() -> ShoppingAgentConfig:
    return ShoppingAgentConfig(
        ...
        domain_search_notes=(
            ...
            "SCENTAI uses an affiliate merchant-clickout model for fragrance products, not an internal checkout. "
