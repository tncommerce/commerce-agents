...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Safely deactivate one SCENTAI merchant job "
            "and revoke its write approval."
        )
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Explicit human confirmation for disabling "
            "the merchant job and revoking approval."
        ),
    )
