...
The current DUFYND live catalog is still heavily skewed toward men's and male-leaning unisex fragrances. The audited live distribution is 32 men's target assignments, 17 unisex assignments and only 2 women's assignments across 33 live fragrances; target assignments can overlap. In addition, 35 verified candidates now sit in isolated pre-live staging with no overlap against the live catalog, giving 68 unique fragrance identities across live + staging. The next expansion must improve mainstream demand coverage, women's fragrance coverage, niche discovery, and Arabic/value alternatives while keeping the catalog curated.
