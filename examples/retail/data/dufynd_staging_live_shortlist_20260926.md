...
A dedicated public-rights evidence review is recorded in `dufynd_image_rights_evidence_20260926.md`. It confirms that official manufacturer product pages remain identity evidence only and are not treated as approved commercial image sources for this shortlist.
