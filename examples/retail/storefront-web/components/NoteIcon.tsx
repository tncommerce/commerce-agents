...
const MOTIFS: { motif: Motif; names: string[] }[] = [
  ...
  { motif: "vanilla", names: ["bourbon vanilla", "vanilla orchid", "vanilla", "vanillin"] },
  ...
  { motif: "cocoa", names: ["cocoa", "coffee"] },
  ...
  { motif: "flower", names: ["orange blossom", "neroli", "violet", "rose", "iris", "orris", "magnolia", "carnation", "floral", "lily", "orchid", "mahonia", "nectarine blossom", "everlasting essence", "frangipani", "freesia", "lavandin heart", "lotus", "osmanthus", "peony", "white gardenia", "ylang-ylang"] },
  { motif: "citrus", names: ["orange", "lime", "citrus", "petit grain", "petitgrain"] },
  { motif: "leaf", names: ["sage", "rosemary", "basil", "mint", "papyrus", "wormwood", "davana", "fougère accord", "green accord", "green notes", "hay", "juniper"] },
  ...
  { motif: "spice", names: ["ginger", "cardamom", "cinnamon", "nutmeg", "coriander", "spices", "clove", "saffron"] },
  { motif: "sweet", names: ["praline", "chestnut", "coumarin", "almond", "bourbon", "brown sugar", "caramel", "ethyl maltol", "hazelnut", "liquorice", "marshmallow", "milk", "rum", "sugar"] },
