...
| --- | --- | --- |
| Creed Absolu Aventus 100 ml | The live DUFYND scene still reads **75 ML / 2.5 FL.OZ.** and remains invalid as product truth. A new black, volume-neutral candidate avoids the contradictory size marking, but Creed's current 100 ml page still uses variant-ambiguous imagery. | Candidate stored at `examples/retail/review-assets/product-candidates/creed-absolu-aventus-p0-v1.webp`; keep it inactive until the exact 100 ml variant is resolved or a volume-neutral exact-reference gate can be completed. |
| Prada L'Homme EDT 100 ml | Current live editorial remains unsuitable as product truth. A new neutral P0 candidate now captures the architectural bottle, black Saffiano treatment, mirrored silver face and silver cap substantially better. | Candidate stored at `examples/retail/review-assets/product-candidates/prada-lhomme-p0-v5.webp`; keep it inactive until direct exact-reference side-by-side QA passes. |
| Giorgio Armani Stronger With You Intensely 100 ml | Current live editorial remains unsuitable as product truth. The refined V3 candidate now matches the cognac liquid, shoulder-shaped glass and gunmetal cap treatment much more closely and corrects V2's overly broad body and dominant stopper/ring stack. | Candidate stored at `examples/retail/review-assets/product-candidates/armani-swy-intensely-p0-v3.webp`; keep it inactive until exact-reference side-by-side QA passes. |
| Sospiro Vibrato 100 ml | The exact 100 ml reference is locked and the current live 4:3 scene remains editorial-only. The refined V2 candidate now follows the deep-green velvet bottle, smaller oval gold plaque and more proportionate sculpted gold cap direction substantially more closely. | Candidate stored at `examples/retail/review-assets/product-candidates/sospiro-vibrato-p0-v2.webp`; keep it inactive until direct exact-reference side-by-side QA passes. |
